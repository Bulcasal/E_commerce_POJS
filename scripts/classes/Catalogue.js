class Catalogue {
  ...
  createModalHtml(selectedProduct) {
    ...
    divCreated.innerHTML = `<div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  /**
   * Ferme la popup du produit sélectionné
   */
  closeToast(bodySupport) {
    const toastCloseButtonNode = document.getElementsByClassName(
      "btn-close ms-2 mb-1"
    );
